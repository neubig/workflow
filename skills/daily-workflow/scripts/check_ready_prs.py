...
Usage:
    python check_ready_prs.py --user YOUR_GITHUB_USERNAME
    python check_ready_prs.py --user YOUR_GITHUB_USERNAME --ready-only
    python check_ready_prs.py --user YOUR_GITHUB_USERNAME --draft-only
"""
